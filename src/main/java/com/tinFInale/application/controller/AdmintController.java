...
public class AdmintController {
    ...
    @GetMapping("/getAllEmployeesWithDepartments/sortBy/{sort}/{order}")
        public List<EmpDept> gelAllEmployeesWithSort(@PathVariable("sort") String sortBy, @PathVariable("order") String sortOrder){

        var sortedEmployeeDeptList = empDeptRepository.findAll()
                .stream()
